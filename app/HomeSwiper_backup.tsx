  ...
  return (
    <div className="h-screen w-full bg-white overflow-hidden">
      ...
      >
        ...
        {/* スライド2: 360%上昇 */}
        <SwiperSlide>
          <div className="relative h-full w-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden px-6 py-12" style={{ fontFamily: serifFont }}>
