      ...
      <div className="relative z-10">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-12 text-base leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-slate-900">4. 安全管理措置</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-slate-900">5. ユーザーの権利</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-slate-900">6. Cookie等の利用</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-slate-900">7. 方針の変更</h2>
              <p>
