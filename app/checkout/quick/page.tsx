    ...
    <DashboardLayout pageTitle={t('title')} pageSubtitle={t('subtitle')}>
      <div className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6">
        <div className="space-y-6">
          {/* Navy hero — mock: D-Swipe Checkout.html */}
          <section
            className="rounded-3xl px-6 py-6 shadow-[0_22px_44px_-24px_rgba(2,132,199,.34)] sm:px-8"
            style={{ background: HEAD_BG }}
          >
            <p className="text-xs font-bold uppercase tracking-[.16em] text-cyan-300">Checkout</p>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="text-lg font-bold text-navy-900">{t('profile.heading')}</h2>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full px-6 py-2 text-sm font-bold text-pure-white shadow-[0_10px_26px_-8px_rgba(6,182,212,.55)] transition-shadow hover:shadow-[0_18px_48px_-12px_rgba(6,182,212,.5)] disabled:cursor-not-allowed disabled:opacity-50"
