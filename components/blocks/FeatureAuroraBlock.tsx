...
export default function FeatureAuroraBlock({ content, isEditing, onEdit }: FeatureAuroraBlockProps) {
  ...
  return (
    <Section tone="none" padding="compact" className="overflow-hidden sm:min-h-0" style={{ backgroundColor: surface, color: bodyColor }}>
      ...
      <div className="relative space-y-9 sm:space-y-12 md:space-y-6 pt-[10rem] pb-20 sm:pt-0 sm:pb-0" style={{ color: bodyColor }}>
