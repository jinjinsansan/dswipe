...
export default function FeatureAuroraBlock({ content, isEditing, onEdit }: FeatureAuroraBlockProps) {
  ...
  return (
    <Section tone="none" padding="compact" className="overflow-hidden sm:min-h-0 py-0 -mt-8 sm:mt-0 sm:py-section-xs" style={{ backgroundColor: surface, color: bodyColor }}>
