...
export default function PricingBlock({ content, isEditing, onEdit }: PricingBlockProps) {
  ...
  return (
    <Section
      tone="none"
      padding="compact"
      className="pt-4 pb-20 sm:pt-5 sm:pb-20 md:pt-6 md:pb-20 lg:pt-9 lg:pb-20"
        ...
        <div className={`grid grid-cols-1 ${gridCols} gap-3 md:gap-3 lg:gap-4`}>
          {plans.map((plan, index) => (
            ...
            >
              {/* プラン名 */}
              <h3
                className="text-xs font-bold mb-0.5 sm:text-lg"
              ...
              {/* 機能リスト */}
              <ul className="mb-3 space-y-1 sm:space-y-2 sm:mb-6">
