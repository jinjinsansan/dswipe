...
export default function HeroAuroraBlock({ content, isEditing, onEdit, productId, onProductClick }: HeroAuroraBlockProps) {
  const {
    themeKey,
    tagline,
    title,
  ...
  return (
    <Section
      tone="none"
      padding="condensed"
      className="overflow-hidden mt-0 sm:mt-0 pt-10 pb-4 sm:pt-11 sm:pb-15 md:pt-15 md:pb-15 lg:py-section-lg"
      style={{
    ...
    >
      ...
      >
        <div
          className="pt-4 space-y-3 sm:pt-0 sm:space-y-4 md:space-y-5"
