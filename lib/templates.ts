...
export const INFO_PRODUCT_BLOCKS: TemplateBlock[] = [
  ...
  {
    id: "cta-inline-focus-1",
    templateId: "cta-inline-1",
    name: "インラインCTA（ブルーグロー）",
    category: "conversion",
    description: "スライド内で完結するシンプルなCTAセクション",
    defaultContent: {
      themeKey: "power_blue",
      ...
      title: "今すぐAIローンチで成果を加速しませんか？",
      subtitle: "24時間で初稿生成 / CV改善レポート付 / 87%がCVR向上を実感",
      buttonText: "無料デモを申し込む",
      buttonUrl: "/register",
  ...
  // Countdown blocks (5 themes)
  {
    ...
    defaultContent: {
      ...
      textColor: "#F8FAFC",
      title: "⏰ 申込締切まで残りわずか！",
      targetDate: "2025-12-31T23:59:59+09:00",
